...
document.write(`A quantidade de notas 50 sacadas é GC$ ${nota50}<br>`)
document.write(`A quantidade de notas 10 sacadas é GC$ ${nota10}<br>`)
document.write(`A quantidade de notas 5 sacadas é GC$ ${nota5}<br>`)
document.write(`A quantidade de notas 1 sacadas é GC$ ${nota1}<br>`)
